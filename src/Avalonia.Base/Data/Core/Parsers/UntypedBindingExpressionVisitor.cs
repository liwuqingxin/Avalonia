...
internal class UntypedBindingExpressionVisitor<TIn> : ExpressionVisitor
{
    ...
    public UntypedBindingExpressionVisitor(LambdaExpression expression, bool enableDataValidation)
    {
    ...
    {
        var visitor = new UntypedBindingExpressionVisitor<TIn>(expression, enableDataValidation);
