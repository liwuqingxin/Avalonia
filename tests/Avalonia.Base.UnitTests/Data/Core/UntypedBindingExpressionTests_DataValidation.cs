...
{
    public class UntypedBindingExpressionTests_DataValidation : IClassFixture<InvariantCultureFixture>
    {
        [Fact]
        ...
        private UntypedBindingExpression CreateTarget<TIn, TOut>(
            ...
            bool enableDataValidation = true)
                where TIn : class?
        {
            return UntypedBindingExpression.Create(data, value, enableDataValidation: enableDataValidation);
        }
