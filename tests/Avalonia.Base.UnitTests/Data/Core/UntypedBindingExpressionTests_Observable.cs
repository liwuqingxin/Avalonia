...
{
    public class UntypedBindingExpressionTests_Observable
    {
        [Fact]
        ...
        public void Should_Get_Property_Value_From_Observable_With_DataValidation_Enabled()
        {
            using (var sync = UnitTestSynchronizationContext.Begin())
            {
                ...
                var target = UntypedBindingExpression.Create(data1, o => o.Next.StreamBinding().Foo, enableDataValidation: true);
                var result = new List<object>();
